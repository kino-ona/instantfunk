...
// clean
function clean(done) {
	del.sync(['dist/*.html', 'dist/product', 'dist/order', 'dist/member', 'dist/search', 'dist/myshop', 'dist/archive', 'dist/event', 'dist/etc', 'dist/assets/**', '!dist/assets/fonts']);
	done();
}
exports.clean = clean;
...
// 		}
// 		))
// 		.pipe(dest('web/assets/images/ico'));
...
// 		}
// 		))
// 		.pipe(dest('web/assets/images/ico/m'));
// 	const cssStream = spriteData.css
// 		.pipe(buffer())
// 		.pipe(dest('src/assets/css'));
// 	return merge(imgStream, cssStream),
